...
import { OrderDetailsModal, OrderDetailsModalProps } from "../orders/modal/orderDetailsModal";
...
export function ClientOrderTab(props: OrderTabProps) {
    ...
    async function loadOrders(page: number, pageSize: number) {
        const pagedResult = await OrderProvider.getOrderPageByUser(props.id, page, pageSize);
