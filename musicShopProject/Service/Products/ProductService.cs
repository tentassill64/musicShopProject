...
namespace musicShopProject.Service.Products
{
    ...
    public class ProductService : IProductService
    {
        ...
        private Result ValidateProductBlank(ProductBlank blank, out ProductBlank.Validated validatedProduct)
        {
            ...
            validatedProduct = new ProductBlank.Validated(blank.Id.Value!, blank.Name!, blank.Description!, blank.Price.Value!, blank.Category!, blank.Weight.Value!, blank.Manufacturer!, blank.Quantity.Value!, blank.Image!, blank.Status!);
